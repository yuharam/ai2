...
# Google Drive 파일 ID
file_id = '1to0i7QzyRhDlriWbAxJpsmqXtRlcQsVN'
...
content_data = {
    labels[0]: {
        'images': [
            "https://i.ibb.co/kK5RP2S/image.jpg?text=Label1_Image1",
    ...
    labels[1]: {
        'images': [
            "https://i.ibb.co/68jcMpD/image.jpg?text=Label2_Image1",
    ...
    labels[2]: {
        'images': [
            "https://i.ibb.co/P596VGM/image.jpg?text=Label3_Image1",
